        ...
        <h6 className={styles.Heading}>{`Your Go-To`}  <span> Website & Web Application  Development</span>{"Agency in Dubai"}</h6>
           ...
           <div className={`col-lg-6 first-letter: ${styles.cardcont}`}>
                   <div className={styles.card}>
                        <h2> Elevate Your Digital Presence With Digital Mobix: {"Dubai's"} Premier Web Development Agency</h2>
                        <p> At Digital Mobix, we {"don't"} just build websites; we craft digital experiences that leave a lasting impression. As a leading web development agency in Dubai, we have successfully designed and developed over 300 websites, catering to diverse industries both locally and globally.</p>
