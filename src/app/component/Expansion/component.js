    ...
    <section className={`${styles.Expansionsection}`}>
      <div className="container-fluid">
        <div className="row">
          ...
          <div className={`col-lg-6 mt-5 ${styles.Expansionsectionright}`}>
            <div className={styles.FormContainer}>
              <form action="" className={styles.ContactForm}>
                <h3>Got an Idea? <br /> Let’s get started </h3>
                ...
                <div className={styles.Formgrouptextarea}>
                  ...
                  <textarea name="" id="" cols="120" rows="5" className={styles.textarea} placeholder='Type Here' />
                </div>
